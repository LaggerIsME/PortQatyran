...
function print_logo () {
  ...
  echo -e "${blue}▒▒▒▒▒▒▒▒▒▒▒▒▒▒${white}░░░░${blue}▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒${white}░░░░${blue}▒▒▒▒▒▒▒▒▒▒▒▒▒▒${black}${tab}${blue}${bold}Nmap mode: ${clear}${white}T$NMAP_SCAN_MODE${black}"
  echo -e "${blue}▒▒▒▒▒▒▒▒▒▒▒▒▒▒${white}░░░░${blue}▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒${white}░░░░${blue}▒▒▒▒▒▒▒▒▒▒▒▒▒▒${black}${tab}${blue}${bold}Rustscan mode: ${clear}${white}$RUSTSCAN_SCAN_MODE${black}"
